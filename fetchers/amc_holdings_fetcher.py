...
AMC_KEYS: frozenset[str] = frozenset({"nippon", "dsp", "icici", "icici-index", "bajaj", "quant", "qsif", "edelweiss", "altiva", "altiva-sif", "altiva_sif", "amfi", "hdfc", "kotak", "abakkus", "abacus", "helios", "invesco", "canara", "canara_robeco", "canara-robeco", "mirae", "mirae_asset", "mirae-asset", "axis", "axis_mf", "axis-mf", "motilal", "motilal_oswal", "motilal-oswal"})
...
def fetch_amc_holdings(
    ...
    *,
    ...
    kwargs: dict = {}
    if amc in ("nippon", "dsp", "bajaj", "quant", "qsif", "edelweiss", "altiva", "altiva-sif", "altiva_sif", "amfi", "hdfc", "kotak", "abakkus", "abacus", "helios", "invesco", "canara", "canara_robeco", "canara-robeco", "mirae", "mirae_asset", "mirae-asset", "axis", "axis_mf", "axis-mf", "motilal", "motilal_oswal", "motilal-oswal"):

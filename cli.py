...
def run_import(
    ...
    *,
    ...
    _amc_cats = [c for c in ("icici", "nippon", "icici-index", "dsp", "bajaj", "quant", "qsif", "edelweiss", "altiva", "hdfc", "kotak", "abakkus", "abacus", "helios", "invesco", "canara", "mirae", "axis", "motilal") if c in categories]
    if _amc_cats:
